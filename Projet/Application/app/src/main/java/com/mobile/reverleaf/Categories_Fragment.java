    ...
    public void Display(List<CategoryData> _listCategories)
    {
        for(CategoryData _category : _listCategories)
        {
            try
            {
                ...
                LinearLayout _cardCategory = ViewHelper.CreateCategoryCard(getContext(), getResources(), _category.mName, _view->ViewHelper.StartNewIntent(getActivity(), _classActivity, false));
